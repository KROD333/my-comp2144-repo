...
const createScene = async function() {
    ...
    cartMat.diffuseColor = new BABYLON.Color3(1, 0, 1); // bright pink!
    ...
    const wheel1 = BABYLON.SceneLoader.ImportMeshAsync("", "./meshes/", "wheel1.glb").then((result) => {
        // Do this after the mesh has loaded.
        ...
        // Attach the wheel to the cart mesh as its parent.
        wheelMesh.parent = cart;
        // Position the wheel with respect to centre of cart mesh.
