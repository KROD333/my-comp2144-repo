...
const createScene = async function() {
    ...
    faceUV[2]= new BABYLON.Vector4(0.6, 0.0, 1.0, 1.0); //right side face
    faceUV[3]= new BABYLON.Vector4(0.0, 0.0, 0.4, 1.0); //left side face
    ...
    // STEP 14b: Create a third instance of the house object
    ...
    // STEP 15a: Get a 3D model of a tree (from https://free3d.com/3d-model/low_poly_tree-816203.html)
